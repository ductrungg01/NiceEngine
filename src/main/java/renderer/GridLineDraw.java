...
public class GridLineDraw {
    ...
    private static Shader shader = AssetPool.getShader("system-assets/shaders/debugLine2D.glsl");
    ...
    public static void addLine2D(Vector2f from, Vector2f to, Vector3f color, int lifetime) {
        ...
        GridLineDraw.lines.add(new Line2D(from, to, color, lifetime));
    }
