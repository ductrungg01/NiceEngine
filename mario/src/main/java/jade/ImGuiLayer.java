...
public class ImGuiLayer {
    ...
    public void initImGui(){
        ...
        // --------------------------------------------------------
        // Keyboard mapping. ImGui will use those indices to peek into io.KeysDown[] arrays.
        ...
        // -------------------------------------------------------
        // Use freetype instead of stb_truetype to build fonts texture
    ...
    private void startFrame(final float deltaTime){
        ...
        // We SHOULD call those method to update Dear ImGui state for the current frame
        final ImGuiIO io = ImGui.getIO();
